...
if(CMAKE_SYSTEM_PROCESSOR MATCHES "arm")
    if( NOT (CMAKE_CXX_COMPILER_ID STREQUAL "Clang") AND (CMAKE_CXX_COMPILER MATCHES "clang"))
	  set(CXX_NEON_FLAG "${CXX_NEON_FLAG} -mfpu=neon -mfpu=neon-fp16")
	endif()
	if(CMAKE_CXX_COMPILER_ID MATCHES "GNU")
		set(CXX_NEON_FLAG "${CXX_NEON_FLAG}")
	endif()
else()
	set(CXX_NEON_FLAG "")
endif()
...
message(STATUS "CXX_COMPILE_FLAGS: ${COMMON_CXX_FLAGS} ${CXX_NEON_FLAG}")
...
if(SIMD_TEST)
	...
	if((NOT ${SIMD_TARGET} STREQUAL "") OR (CMAKE_CXX_COMPILER_VERSION VERSION_LESS "5.0.0"))
		...
		set_source_files_properties(${TEST_SRC_CPP} PROPERTIES COMPILE_FLAGS "${COMMON_CXX_FLAGS} ${SIMD_TEST_FLAGS} -D_GLIBCXX_USE_NANOSLEEP")
	endif()
